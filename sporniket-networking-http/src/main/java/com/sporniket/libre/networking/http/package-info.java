/**
 * This package should make easier the use of Apache httpclient.
 *
 * <h3>Usages</h3>
 * 
 * <h4>Typical use</h4>
 ...
 *     //...
 *     CallResult _resp = httpProvider//
 *         .perform(Get(theUrl)...)//
 *         .handleResponse(//
 *             new ResponseHandlerBuilder<CallResult>()//
 *             .whenStatusGroup(SC_2XX_SUCCESS, (body, headers, status) -> {
 *                //... build and returns CallResult
 *             })//
 *             .done();
 *         );
 * }
