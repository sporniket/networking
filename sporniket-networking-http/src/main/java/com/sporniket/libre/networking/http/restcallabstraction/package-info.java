/**
 * Agnostic model of a 'REST call'.
 * 
 * <p>
 * This is an abstraction layer for writing integration tests, to make those tests loosely coupled to the underlying framework, e.g. resteasy.
 * </p>
 * 
 * <p>
